    ...
    <nav class="bg-gray-800">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <a href="<?=ROOT?>/home" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" style="font-size: 130% ; font-family: Verdana" aria-current="page">Intellect Quest</a>
              </div>
            </div>
          </div>
          <div class="hidden md:block">
      ...
      <div class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
          <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
          <a href="<?=ROOT?>/home" class="bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium" style="font-size: 130% ; font-family: Verdana" aria-current="page" >Intellect Quest</a>
        </div>
        <div class="border-t border-gray-700 pb-3 pt-4">
          <div class="flex items-center px-5">
              <a href="<?=ROOT?>/login" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Login</a>
              <a href="<?=ROOT?>/signup" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Register</a> 
          </div>
        </div>
      </div>
    </nav>
